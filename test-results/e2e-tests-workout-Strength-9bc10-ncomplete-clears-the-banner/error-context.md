...
- Name: e2e/tests/workout.spec.ts >> Strength workout: log actuals and complete >> marking a completed strength workout incomplete clears the banner
- Location: e2e/tests/workout.spec.ts:356:7
