...
- Name: e2e/tests/workout.spec.ts >> Strength workout: log actuals and complete >> entering values in pill inputs saves actuals
- Location: e2e/tests/workout.spec.ts:302:7
