...
- Name: e2e/tests/workout.spec.ts >> Run workout >> Log Run button is disabled until distance and time are filled
- Location: e2e/tests/workout.spec.ts:392:7
...
Call log:
  - navigating to "/workout/run/cmoqhofq8000llrmferx6k756", waiting until "load"
