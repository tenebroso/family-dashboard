...
- Name: e2e/tests/workout.spec.ts >> Strength workout: log actuals and complete >> clicking checkmark marks a set complete and updates progress
- Location: e2e/tests/workout.spec.ts:316:7
