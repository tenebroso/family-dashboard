...
- Name: e2e/tests/workout.spec.ts >> Strength workout: edit fields >> clicking exercise name in edit mode opens Edit Exercise sheet
- Location: e2e/tests/workout.spec.ts:162:7
