...
- Name: e2e/tests/workout.spec.ts >> Back navigation >> back chevron from calendar-navigated workout returns to that week
- Location: e2e/tests/workout.spec.ts:502:7
